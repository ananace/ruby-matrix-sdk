...
class ApiTest < Test::Unit::TestCase
  ...
  def test_creation_for_domain
    ...
    MatrixSdk::Api
      .expects(:new)
      .with('https://example.com', address: 'matrix.example.com', port: 443)

    MatrixSdk::Api.new_for_domain 'example.com'
  end

  def test_creation_for_missing_domain
    ::Resolv::DNS
      .any_instance
      .expects(:getresource)
    ...
    MatrixSdk::Api
      .expects(:new)
      .with('https://example.com', address: 'example.com', port: 8448)

    MatrixSdk::Api.new_for_domain 'example.com'
  end

  def test_creation_for_domain_and_port
    MatrixSdk::Api
      .expects(:new)
      .with('https://example.com', address: 'example.com', port: 8448)

    MatrixSdk::Api.new_for_domain 'example.com:8448'
  end
end
